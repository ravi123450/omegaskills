        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {workshops.map((workshop, index) => (
            ...
            >
              ...
              <div
                className="absolute top-3 right-3 border border-orange-300 bg-slate-500/30 text-white font-semibold rounded-full px-3 py-1 text-sm"
              >
                {workshop.price}
              </div>
              <div
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {workshop.isExclusive && (
                        <Badge className="ml-1 bg-gradient-to-r from-pink-500 to-amber-300 text-white p-1 text-xs">
                          Exclusive
                        </Badge>
                      )}
                    </div>
